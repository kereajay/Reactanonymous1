    ...
    return (
        <>
            <div className='bg-slate-600  '>
                <div className="grid lg:grid-cols-4 md:grid-cols-3 gap-5 p-16 ">
                    <div className="text-white">
                        ...
                        <ul type="none">
                            ...
                            <li className="flex"><img src="https://www.svgrepo.com/show/444828/location-1.svg" alt="" width={"20px"} />   <span className="ml-4">123 St reet, New York, USA</span></li>
                            <li className="flex"><img src="https://www.svgrepo.com/show/194101/mail-email.svg" alt="" width={"20px"} /> <span className="ml-4">info@example.com</span></li>
                            <li className="flex"><img src="https://www.svgrepo.com/show/226343/telephone-call.svg" alt="" width={"20px"} /> <span className="ml-4">0123456789</span></li>
                    ...
                    <div className="text-white">
                        ...
                        <div className="h-8 w-56 bg-white flex"  >
                            <input type="text" placeholder="Enter Your Email" className="h-8" />
                ...
                <p className='text-white'>&copy; <span className='text-yellow-400 hover:underline'>Domain</span>. All Rights Reserved. Designed by <span className='text-yellow-400 hover:underline'>HTML Codex </span></p>
                <img src="https://demo.htmlcodex.com/1479/online-shop-website-template/img/payments.png" alt="" />
                </div>
            </div>
